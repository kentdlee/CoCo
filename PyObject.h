 ...
 * below are declared as virtual functions, meaning that subclasses of 
 ...
 * http://www.rafekettler.com/magicmethods.html. As I developed the CoCo and
 ...
 * are defined in PyObject but may or may not be implemented.
 * 
 * If any unimplemented method is called on a subclass of PyObject, the
 * PyObject default handling will throw an unimplemented exception to 
 * indicate a wrong method has been called. 
 */
...
public:
	...
	virtual PyType* getType();
        ...
        //This list of methods came from http://www.rafekettler.com/magicmethods.html
        ...
        virtual PyObject* __cmplex__(vector<PyObject*>* args); // editor didn't like __complex__, c++?
